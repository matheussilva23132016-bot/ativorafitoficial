...
export const helpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    keywords: ["voz", "audio", "áudio", "microfone", "falar", "ouvir", "ditado", "ler"],
  ...
  },
  {
    ...
    keywords: ["sugestao", "sugestão", "feedback", "melhoria", "ideia", "bug", "erro", "problema", "travou"],
  ...
  },
  {
    ...
    keywords: ["nutricao comunidade", "nutrição comunidade", "cardapio comunidade", "cardápio comunidade", "pdf cardapio", "baixar cardapio", "rfm comunidade"],
  ...
  },
  {
    ...
    keywords: ["evolucao", "evolução", "metricas", "métricas", "progresso", "historico", "histórico", "medidas", "foto comparativa", "resultado"],
